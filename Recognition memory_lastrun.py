...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Student\\Downloads\\last\\last\\Recognition memory_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    while continueRoutine:
        ...
        if key_instructions.status == NOT_STARTED and t >= 0.0-frameTolerance:
            ...
            key_instructions.clearEvents(eventType='keyboard')
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            if test_response.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                ...
                # keyboard checking is just starting
                test_response.clock.reset()  # now t=0
                test_response.clearEvents(eventType='keyboard')
